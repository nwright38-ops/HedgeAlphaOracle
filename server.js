...
function checkPayment(req, res, next) {
  ...
  if (!paymentSig) {
    ...
    // x402 v2 standard format — required for Bazaar and x402scan compatibility
    res.set('PAYMENT-REQUIRED', JSON.stringify({
      x402Version: 2,
      accepts: [
        {
          scheme: 'exact',
          ...
          resource: resource,
          description: 'HedgeAlphaOracle ' + tier + ' signal — crypto & stock trading signals',
